...
term("My name is ").red("Jack")(" and I am ").green("32\n");
term("My name is ^rJack^ and I am ^g32\n");
...
// ... and formated
term.moveTo(1, 1, 'My name is %s, I am %d.\n', 'Jack', 32);

// ... or even combined with other styles
term.moveTo.cyan(1, 1, "My name is %s, I am %d.\n", 'Jack', 32);
