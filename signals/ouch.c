 ...
 * 
 * gcc -I ../lib/ ../lib/error_functions.c ouch.c
 */
...
main(int argc, char *argv[]) {
     ...
     * API to establish a signal handler, but for the reasons described
     * in Section 22.7 of TLPI, sigaction() is the (strongly)
